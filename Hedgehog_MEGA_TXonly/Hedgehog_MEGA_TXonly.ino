 ...
 *  Date      : 02/12/21
 *  Ce code permet de vérifier la communication entre un Arduino MEGA et une balise mobile (hedgehog) Marvelmind
 */
 ...
 */
  ...
  * Nous configurons la communication Serial avec l'ordinateur avec un baudrate de 115200 bps aussi. 
  */
...
void setup_hedgehog(){
  Serial3.begin(115200); // hedgehog transmits data on 115200 bps  
...
void setup_debug(){
  Serial.begin(115200); // Arduino transmits data to PC on 115200 bps
}
