...
void stopMarvelmindModem (struct MarvelmindModem * modem){
    modem->terminationRequired=true;
    if (modem->verbose) puts ("Stopping thread");
    #ifdef WIN32
