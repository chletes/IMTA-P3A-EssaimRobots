 ...
 * @version: 
 * @Author: Wentao GONG
 * @Date: 2022-03-03 17:53:10
 * @LastEditors: Wentao GONG
 * @LastEditTime: 2022-03-03 18:49:33
 */
/*
  ...
  *rty_y1, real_T *rty_theta, DW_robot_Model_robot_T *localDW)
{
  ...
  *rty_y1 = localDW->DiscreteTimeIntegrator2_DSTATE;
   ...
   *  Sum: '<S1>/Sum1'
   */
  localDW->DiscreteTimeIntegrator_DSTATE += 1.0 / L * (rtu_Vd - rtu_Vg) * SAMPLING_TIME;

  /* Update for DiscreteIntegrator: '<S1>/Discrete-Time Integrator1' */
  localDW->DiscreteTimeIntegrator1_DSTATE += SAMPLING_TIME * rtb_linearisation_calcul_u1;

  /* Update for DiscreteIntegrator: '<S1>/Discrete-Time Integrator2' */
  localDW->DiscreteTimeIntegrator2_DSTATE += SAMPLING_TIME * rtb_linearisation_calcul_u2;
}
